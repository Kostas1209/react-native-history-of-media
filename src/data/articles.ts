export const articles: Article[] = [
  ...
  },
  {
    ...
    article:
      'Фенакистископ - це лабораторний прилад який слугує для демонстрації рухомих різних малюнків У 1832 році Жозеф Плато створив прилад оптичного обману, який пізніше був названий фенакистископ. Сам Жозеф охарактеризував свій винахід так: «... принцип дії сучасного кіно, або, скоріше, закон, на якому заснована зйомка або проектування фільмів». Прилад складається з картонного диска з прорізани- ми в ньому отворами, на якому зображені різні фігури. Під час обертання диска перед дзеркалом фігури, які проглядаються в дзеркалі через отвори диска, починають робити рухи в залежності від задум- ки ілюстрації. Хоча, здавалося б, що вони будуть обер- татися разом з диском. Цікавий факт: майже в цей же час професор геометрії Симон фон Штампфер створив апарат, дуже схожий на фенакистископ, і назвав його «стробоскопом». Ці двоє людей не знали робіт один одного і прийшли до своїх винаходів кожен своїм шляхом.',
    imageName: 'maya',
    imageBreiflyInformation: '',
  },
  {
